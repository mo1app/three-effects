...
const PLAYGROUND_DEFAULT_EFFECTS = {
  ...
  groupA: {
    gradientOverlay: {
      ...
      reverse: true,
      stops: [
        { color: "#a6a6a6", position: 0.000280688622754491 },
        { color: "#ff70fa", position: 0.28822043413173654 },
        { color: "#8f96ff", position: 0.48574335703592814 },
        { color: "#00ff2a", position: 0.7374157934131736 },
  ...
  return {
    ...
    layers: [
      ...
      },
      {
        ...
        color: "#ff0066",
        visible: true,
        opacity: { enabled: true, value: 0.97 },
      },
    ],
